...
@Component({
  ...
  imports: [HeaderAdminSistemaComponent, CineCardComponent, CineCardComponent, BuscadorComponent, ToastComponent, HeaderAdminCineComponent, HeaderUsuarioNormalComponent, AnuncioCardComponent],
...
export class CinesDisponiblesPage implements OnInit {
  ...
  constructor(private cinesServices: CineServices, private anunciosServices: AnuncioServices) {
  }
