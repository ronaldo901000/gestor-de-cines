...
@Component({
  ...
  imports: [HeaderAdminSistemaComponent, RouterLink, ReporteGananciasAnuncianteFormComponent, ReporteSalasPopularesFormComponent, ReporteSalasComentadasFormComponent, ReporteGananciasFormComponent],
