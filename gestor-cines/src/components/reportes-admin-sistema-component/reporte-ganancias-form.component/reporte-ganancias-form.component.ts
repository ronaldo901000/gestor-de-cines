...
@Component({
  selector: 'app-reporte-ganancias-form-component',
  imports: [ToastComponent, FormsModule, ReactiveFormsModule],
  templateUrl: './reporte-ganancias-form.component.html',
})
export class ReporteGananciasFormComponent {
  ...
  generar(): void {
    if (this.filtroForm.valid) {
      ...
      const url = this.reporteServices.generarURLReporteGanancias(this.nuevoFiltro);
