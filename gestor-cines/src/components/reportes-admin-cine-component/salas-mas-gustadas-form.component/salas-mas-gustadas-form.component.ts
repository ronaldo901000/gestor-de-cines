...
@Component({
  selector: 'app-salas-mas-gustadas-form-component',
  imports: [ToastComponent, FormsModule, ReactiveFormsModule],
  templateUrl: './salas-mas-gustadas-form.component.html',
})
export class SalasMasGustadasFormComponent {
  @ViewChild('toast') toast!: ToastComponent;
  @Input({ required: true })
  codigoCine!: String;
  nuevoFiltro!: FiltroComentariosSalas;
  filtroForm!: FormGroup;
  endPoint: string = 'reporte-top-salas-gustadas';
