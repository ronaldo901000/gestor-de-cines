...
@Component({
  selector: 'app-boletos-vendidos-form-component',
  imports: [ToastComponent, FormsModule, ReactiveFormsModule],
  templateUrl: './boletos-vendidos-form.component.html',
})
export class BoletosVendidosFormComponent {
  @ViewChild('toast') toast!: ToastComponent;
  @Input({ required: true })
  codigoCine!: String;
  nuevoFiltro!: FiltroComentariosSalas;
  filtroForm!: FormGroup;
  endPoint: string = 'reporte-boletos-vendidos-salas';
